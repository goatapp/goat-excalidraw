          ...
          <div className="absolute inset-0 z-10 flex items-center justify-center rounded-2xl bg-white/90 dark:bg-neutral-900/90 backdrop-blur-sm">
            <div className="w-full max-w-sm p-6 space-y-4">
              ...
              <input
                ...
                autoFocus
                className="w-full px-3 py-2 rounded-xl border-2 border-black dark:border-neutral-700 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 text-sm font-medium focus:outline-hidden focus:ring-2 focus:ring-indigo-500"
              />
